...
import "../../../styles/solutions/moreSolutions.css";
        ...
        <Container id="moreSolutions" maxWidth={false} disableGutters={true} sx={{p : 0}}>
            ...
            {showInfo &&
                <Grid container className="gridFlexColumn" sx={{paddingLeft: "14.58%", paddingRight: "14.58%"}}>
                    <p>More Solutions Desplegable</p>
                </Grid> 
            }              
        </Container>
    )
